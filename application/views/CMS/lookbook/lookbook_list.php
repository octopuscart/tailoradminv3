...
<div id="content" class="content">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Your Look Book <small></small></h1>
    <!-- end page-header -->
...
<!--    <div id="options" class="m-b-10">
    ...
    <div id="gallery" class="gallery row">
        ...
        foreach ($blog_data as $key => $value) {
            ?>   
            <div class="image gallery-group-1 col-md-4">
                <div class="image-inner">
                    <a href="<?php echo base_url(); ?>assets/look_books/<?php echo $value['look_book_image']; ?>" data-lightbox="gallery-group-1">
                        <img src="<?php echo base_url(); ?>assets/look_books/<?php echo $value['look_book_image']; ?>" alt="" />
                    </a>

                </div>
                <div class="image-info">
                    <h5 class="title"><?php echo truncate($value['look_book_title'], 100); ?></h5>
             

                    <hr style="margin:5px 0px;"/>
                    <a href="<?php echo site_url('CMS/lookbookDelete/' . $value['id']); ?>" class="" style='margin-top: 10px;'><i class='fa fa-trash'></i> Delete</a>
