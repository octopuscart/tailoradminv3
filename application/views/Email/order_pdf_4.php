...
<tr style="">
    ...
    <td style="text-align: right;width: 60px;text-align: right;padding: 0px 10px;border: 1px solid rgb(157, 153, 150);border-collapse: collapse;"><?php echo globle_currency . " " . number_format($order_data->shipping, 2, '.', ''); ?> </td>
</tr>
<tr style="">
    ...
    <td style="text-align: right;width: 60px;text-align: right;padding: 0px 10px;border: 1px solid rgb(157, 153, 150);border-collapse: collapse;"><?php echo globle_currency . " " . number_format($order_data->discount, 2, '.', ''); ?> </td>
</tr>
<tr style="">
