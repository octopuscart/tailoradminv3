                            ...
                            <tr class="item_headers items_row">
                                ...
                                <td>
                                    <form action='#' method="post" class='pull-right'>
                                        ...
                                        <button type='submit' class='btn btn-warning btn-sm' name='update_category' value='<?php echo $value->id; ?>' style='    margin-top: -4px;'><i class='fa fa-edit'></i> Update</button>
                                        <button type='submit' class='btn btn-danger btn-sm' name='delete_category' value='<?php echo $value->id; ?>' style='    margin-top: -4px;'><i class='fa fa-trash'></i> </button>
                                    </form>
                                </td>
                            </tr>
                            <?php
